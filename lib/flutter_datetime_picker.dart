...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    dateTimeTheme.DatePickerThemeCustom? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? dateTimeTheme.DatePickerThemeCustom(),
  ...
  final dateTimeTheme.DatePickerThemeCustom theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    dateTimeTheme.DatePickerThemeCustom theme = widget.route.theme;
  ...
  Widget _renderPickerView(dateTimeTheme.DatePickerThemeCustom theme) {
  ...
  Widget _renderItemView(dateTimeTheme.DatePickerThemeCustom theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(dateTimeTheme.DatePickerThemeCustom theme) {
